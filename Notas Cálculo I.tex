...
\begin{enumerate}[label=\alph*)]
    ...
    \item Por la propiedad arquimediana, el conjunto $E\defined{m\in \N: y<m}$ es no vacío. Además, por el principio del buen orden, $\exists n\in E$ tal que $n\leq m, \for m\in E$. Notemos que $n-1<n$, por lo que $n-1\notin E$, lo que implica que $n-1\leq y<n$. \qed
\end{enumerate}

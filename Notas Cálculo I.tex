...
%
    ...
    \vspace{-1em}\begin{proof} 
        Por definición $b-a\in \R^+$ y $d-c\in \R^+$. Por cerradura de la suma en $\R^+$ se verifica que $(b-a)+(d-c)=b+d-a-c\in \R^+$. Por distribución del signo $b+d-a-c=b+d-(a+c)\in \R^+$, es decir, $a+c<b+d$.
    \end{proof} \vspace{-1em}
...
\begin{enumerate}[label=\alph*)]
    ...
    \item Por definición, \begin{align*}
        1^{n+1} = \left\{
            ...
            \end{array} \right.
        \end{align*}
    Si $n+1=1$, sigue que $n=0$, pero $n\geq 1$, lo que es una contradicción. Por tanto, $1^{n+1}=1\cdot 1^n=1^n$, por (ii) se verifica que $1^n=1$, es decir, $1^{n+1}=1$, lo que implica que $n+1\in A$.
    \end{enumerate}
    ...
    \item Por definición \vspace{1em}\begin{align*}
        ...
        Si $m+1=1$, entonces $m=0$, pero $m\geq 1$, por lo que $a^{m+1}=a\cdot a^m=a^m\cdot a^1$, lo que implica que $1\in A$.
    ...
    Si $m+(n+1)=1$, sigue que $m+n=0$, y por la cerradura de la suma en $\N$, $0\in \N$, lo que es una contradicción. Por tanto, \vspace{1em}\begin{align*}
    ...
    \vspace{-1em}
    \begin{proof}
    Por casos: \begin{enumerate}[label=\roman*)]
    \item Si $m=n$, entonces $\frac{a^n}{a^m}=1$
    \item Si $n-m=1$, entonces $a^{n-m}=a$
    \end{enumerate}\vspace{-1em}
    \end{proof} \vspace{-1em}

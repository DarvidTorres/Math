...
Sea $A \coloneqq \{a_1, \dots, a_n\}$ no vacío. Procederemos por inducción sobre $n\in \N$. \begin{enumerate}[label=\roman*)]
    \item Si $n=1$, tenemos $A\coloneqq\{a_1\}$, de modo que para $m=a_1$ y $n=a_1$ se cumple la condición.
    \item Supongamos que la propiedad se cumple para $n=k$.
    \item Consideremos el conjunto $A\coloneqq \{a_1, \dots, a_k, a_{k+1}\}$. Por hipótesis de inducción, $A' \coloneqq A \backslash \{a_{k+1}\} = \{a_1, \dots, a_k\}$ tiene elemento mínimo y máximo.
\end{enumerate}

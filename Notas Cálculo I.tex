...
\end{enumerate}
Si suponemos que bajo $\Omega$, $2=0$, por notación tenemos que $1+1=0$, por lo que $1+1$ no sería un miembro distinto a los conocidos, en cuyo caso $\Omega$ cumpliría con todos los axiomas de campo consistentemente y constaría de los elementos $0$ y $1$ únicamente.

...
\begin{itemize}
\item Si $x\in \R$, representaremos con el símbolo $x^2$ a la multiplicación $x\cdot x$.%, y lo llamaremos el cuadrado de $x$.
...
%Asimismo, de la notación (ii) obtenemos que podemos usar cualquiera de los símbolos \begin{itemize}%[label=\roman*)]
%    \item $xyz$
%    \item $xzy$
%    \item $yxz$
%    \item $yzx$
...
%    \item $xyz$
%\end{itemize}
%Para representar la multiplicación de $x$, $y$ y $z$.
...
\textbf{Nota:} El uso de notación es opcional y en ocasiones prescindiremos de ella para procurar claridad.% en las demostraciones.
...
%Notemos que si $x\in \R$ tal que $x\in \R^+$, se verifica que $\exists (-x)\in \R$ y
...
\end{itemize}
Usando la definición, tenemos que $x\in \R^+ \Longleftrightarrow -x\in \R^-$, y de forma equivalente, $-y\in \R^+ \Longleftrightarrow y\in \R^-$, pues $-(-y)=y$. Notemos que por definición, si $x\in \R$ con $x\neq 0$, $x$ y $-x$ pertenecen a conjuntos disjuntos, uno es positivo y el otro negativo.% A este hecho lo llamaremos la disjunción de inversos aditivos.
%\bfit{Definición:}\begin{itemize}
%    \item Al conjunto $\R^+\defined \set{0<x| x\in \R}$ lo llamaremos conjunto de los números reales positivos.
%    \item Al conjunto $\R^-\defined \set{x<0| x\in \R}$ lo llamaremos conjunto de los números reales negativos.
%\end{itemize}
...
%\vspace{-1em}
%\begin{proof}
%Si $0\in \R^-$, entonces $-0=0\in \R^+$, pero cero no es positivo. Por tanto, $0\notin \R^-$.
%\end{proof} \vspace{-1em}
%
...
\begin{itemize}
\item Si $x-y\in \R^+$, diremos que $x$ es mayor que $y$ y escribiremos $y<x$ (o $x>y$).% o $x>y$.
\item Si $x-y\in \R^-$, diremos que $x$ es menor que $y$ y escribiremos $x<y$ (o $y>x$).% o $y>x$.
\end{itemize}

%Por tricotomía, para cada $x\in \R$ con $x\neq 0$, tenemos que $x\in \R^+$ o $x\in \R^-$. Como $x=x+0=x-0$, sigue que
...
%Por tricotomía, para cada $x\in \R$ con $x\neq 0$ tenemos que $x\in \R^+$ o $-x\in \R^+$. \vspace{-1em}\begin{enumerate}[label=\roman*)]
%    \item Sabemos que $x=x+0=x-0$, por lo que si $x\in \R^+$, entonces $x-0\in \R^+$, lo que escribimos como $0<x$.% Por tanto, definimos $\R^+\defined \set{0<x:x\in \R}$.
%    \item Sabemos que $-x=0-x$, por lo que si $-x\in \R^+$ tenemos $0-x\in \R^+$, lo que escribimos como $x<0$.% Por tanto, definimos $\R^-\defined \set{x<0:x\in \R}$.
%\end{enumerate}\vspace{-1em}
%%\bfit{Teorema:} $y\in \R^-$ si y solo si $y<0$. (Definición de número real negativo).
%\vspace{-1em}
%\begin{proof} \leavevmode
%    \begin{itemize}
%    \item[$\Rightarrow)$] Si $y\in \R^-$, entonces $-y\in \R^+$. Como $-y$ es inverso aditivo positivo, sigue que $y<0$.
%    \item[$\Leftarrow)$] Si $y<0$, entonces $-y\in \R^+$, ya que es inverso aditivo positivo. Como $-y$ es positivo, sigue que $y\in \R^-$. \qedhere
%    \end{itemize}
%\end{proof} \vspace{-1em}
%
...
\end{itemize}
%
%\textbf{Definición:} Para cada $x\in \R$ se verifica que $x+0=x-0$, por lo que si $x\in \R^+$ tenemos $x-0\in \R^+$, lo que escribimos como $0<x$. Por tanto, definimos $\R^+\defined \set{0<x:x\in \R}$.
%
%\textbf{Definición:} Para cada $x\in \R$ se verifica que $\exists (-x)\in \R$. Notemos que $-x=0-x$, por lo que si $-x\in \R^+$ tenemos $0-x\in \R^+$, lo que escribimos como $x<0$. Definimos al conjunto de los números reales negativos como sigue: $\R^-\defined \set{x<0:x\in \R}$.
%
...
%\end{itemize}
%
%\textbf{Notación:} Sean $x$, $y$ y $z$ números reales, utilizaremos la notación $m<n<z$ para indicar que $x<y$ y $y<z$.

...
\item Si $x$ y $y$ son números reales, representaremos con cualquiera de los símbolos $xy$ o $yx$ a la multiplicación $x\cdot y$; a esta multiplicación la llamaremos el producto de $x$ y $y$.
...
\item Si $x$, $y$ y $z$ son números reales, representaremos con cualquiera de los símbolos \begin{enumerate}[label=\roman*)]
    ...
    \item $x\cdot y\cdot z$
\end{enumerate}
A la multiplicación de $x$, $y$ y $z$. Podemos usar esta notación sin ambigüedad ya que hemos probado que todas las formas de multiplicar tres números reales son equivalentes. Asimismo, de la notación (ii) obtenemos que podemos usar cualquiera de los símbolos \begin{enumerate}[label=\roman*)]
    \item $xyz$
    \item $xzy$
    \item $yxz$
    \item $yzx$
...
%Esta notación es útil pues
Observemos que $(-x)\cdot y = -(x \cdot y)=x\cdot (-y)$ puede reescribirse como $(-x)y=-(xy)=x(-y)$, por la notación (ii), sin embargo, de esta no se obtiene el símbolo $-xy$.
...
%
\item Si $x$ es un número real, representaremos con el símbolo $x^2$ a la multiplicación $x\cdot m$, y lo llamaremos el cuadrado de $x$.

\item Si $x$ y $y$ son números reales y $y$ es distinto de cero, representaremos con el símbolo $ \frac{x}{y}$ al número $x \cdot y^{-1} $.

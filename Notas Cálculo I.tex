...
Supongamos que existen 0 y $\tilde{0}$ números reales tales que $a+0 = a$ y $a+\tilde{0} = a$. Notemos que: \begin{align*}
    ...
    \end{align*}
    Por la unicidad del inverso aditivo, tenemos que $(-a)+ (-b)=-(a+b)$.
    \qed
    ...
    \textbf{Demostración:} \begin{align*}
    -\bigl(a+(-b)\bigr)&= (-a) + \bigl(-(-b)\bigr) &&\text{Demostrado anteriormente} \\
...
Continuemos enunciando los axiomas de campo:

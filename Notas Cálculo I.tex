...
\begin{enumerate}[label=\arabic*)]
    ...
    \item Sí, pues $1\in \R^+$ y y si $n$ es un número real positivo, $n+1 \in \R^+$ por el aximoa de orden 1.
...
\begin{enumerate}[label=\arabic*.]\setcounter{enumi}{2}
    ...
    \item \begin{enumerate}[label=\roman*)]
        \item Sea $M$ el supremo de $S$. Si $s_\varepsilon$ es una cota superior del conjunto, tenemos que $M<s_\varepsilon$. Sea $@e=ejemplo$
    \end{enumerate}
\end{enumerate}

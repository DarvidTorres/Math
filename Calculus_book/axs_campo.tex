...
\begin{enumerate}[label=\roman*)]
  ...
  \textbf{Nota:} Para concluir que $a=0$ necesitamos verificar que $2\neq 0$, pero esto no ha sido demostrado.
...
Resulta conveniente preguntarse ¿qué elementos pertenecen a $\Omega$?

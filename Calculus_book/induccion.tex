...
\begin{enumerate}[label=\alph*)]
  ...
  \begin{proof}\leavevmode
    ...
    \begin{enumerate}[label=\Roman*)]
      ...
      \item Si $a,b\in \Z^-$, entonces $-a,-b \in\N$, y por la cerradura de la suma en $\N$, sigue que $(-a)+(-b)=-(a+b)\in \N$, por lo que $-\bigl(-(a+b)\bigr)=a+b\in \Z^-$ y a su vez, $a+b\in \Z$.
  ...
  \begin{proof}\leavevmode
    \begin{enumerate}[label=\roman*)]
      ...
      \item Si $a,b\in \Z^-$, se tiene que $-a,-b\in \N$, y por la cerradura de la multiplicación en $\N$, sigue que $(-a)\cdot (-b)=ab\in \N$.

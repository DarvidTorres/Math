...
\bfit{Definición (versión 1):} Sea $A\subseteq \R$. Decimos que $A$ es denso (en $\R$), o que cumple la propiedad de densidad, si para cada $x,y \in \R$ con $x<y$, existe $a\in A$ tal que $x<a<y$.

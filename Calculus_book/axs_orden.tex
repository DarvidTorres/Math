...
%  \bfit{Corolario:} Si $a<b$ y $c<d$, entonces $c-b<d-a$.
...
%   Nota: Si $a<b$ y $c<d$, podemos plantear una desigualdad de las siguientes maneras (el lector debería verificar este hecho):
%   \begin{enumerate}[label=\roman*)]
%     \item $a<b\leq c < d$.
%     \item $a<c \leq b < d$
...
\end{proof}
  ...
  \bfit{Corolario:} Si $a\leq b \leq c$, entonces
  \begin{enumerate}[label=\roman*)]
    \item $c-b \leq c - a$, y
    \item $b - a \leq c - a$.
  \end{enumerate}
...
%  \bfit{Conclusión:} El inverso multiplicativo preserva el orden.
 \begin{itemize}
...
%   \end{itemize}
 ...
 \bfit{Conclusión:} Si son todos positivos, se conserva el orden, es decir, si $0<a<b$ y $0<c<d$, entonces $ac<bd$. Luego, sin pérdida de generalidad,
 \begin{itemize}

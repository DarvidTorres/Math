...
Usualmente la sumatoria se presenta con la notación índice para conjuntos finitos, \[\sum_{i=m}^{n} a_i\]

en la cual se tiene una función $f:A \to M$ tal que $i \mapsto a$, donde $i\in M\propersubset \N$.

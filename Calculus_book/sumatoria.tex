...
\begin{enumerate}[label=\alph*)]
  ...
  \textbf{Nota:} El lector encontrará que en ocasiones, en lugar de utilizar este teorema simplemente se trabaja con susbsituciones sobre el índice, especialmente para casos en que $f(x)=x$. Por ejemplo:

...
En principio, la sumatoria está bien definida para casos en los que los índices no son enteros, por ejemplo:

\begin{align*}
  \sum_{i=\frac{1}{2}}^{\frac{9}{4}} i &= \frac{1}{2} + \sum_{i=\frac{3}{2}}^{\frac{9}{4}} i \\
  &= \frac{1}{2} + \frac{3}{2} + \sum_{i=\frac{5}{2}}^{\frac{9}{4}} i\\
  &= \frac{1}{2} + \frac{3}{2} + 0\\
  &= 2
\end{align*}

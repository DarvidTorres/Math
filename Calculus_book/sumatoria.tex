...
\begin{enumerate}[label=\alph*)]
  ...
  \textbf{Nota:} El lector encontrará que en ocasiones, en lugar de utilizar este teorema simplemente se trabaja con susbsituciones sobre el índice, especialmente para casos en que $f(x)=x$. Por ejemplo, tomando la sumatoria de $f(n)=n$, de $1$ hasta $b$,
  ...
  Al sustituir $a$ en la sumatoria, tenemos
  
  \[\sum_{a=1}^{b} a = \sum_{c=0}^{b-1} c+1\]

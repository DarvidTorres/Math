...
\textbf{Definición:} Sea $A\propersubset \R$ y $B=\set{a|1\leq a\leq n}\propersubset \N$. Decimos que $A$ es un conjunto finito si existe una biyección $f: A \to B$, para algún $n \in \N$.

...
\textbf{Definición:} Sea $n,k\in \Z$ tales que $0\leq k\leq n$. Definimos al coeficiente binomial como sigue: \[\binom{n}{k}\defined \frac{n!}{k!(n-k)!}\]

Decimos que ``(de) $n$ elije k". Otras notaciones para $\binom{n}{k}$ son $C(n, k), {}_nC_k, {}^nC_k, C_{n,k}$.

\textbf{Observación:}

\begin{itemize}
  \item \[\binom{n}{0} = \frac{n!}{0!(n-0)!} = \frac{n!}{1(n)!} = 1\]
  \item \[\binom{0}{k} = 0\]
\end{itemize}

...
Sea $n=1$. Notemos que para la sumatoria \[\sum_{i=0}^{n} \sum_{j=0}^{i} (i+1)(j+1) = \sum_{i=0}^{n} (i + 1) \cdot \sum_{j=0}^{i} (j+1)\] se tiene que $i\in \set{0+m|m\in \Z, 0\leq m\leq 1}=\set{0, 1}$ y $j\in \set{0, 1}$.

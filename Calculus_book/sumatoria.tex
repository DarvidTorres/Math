...
i &\mapsto a
\end{align*}
donde $N\subseteq \N$. Por ejemplo:
...
El índice de la sumatoria puede iterar sobre los elementos de un conjunto indexado, por ejemplo, \[\sum_{i\in \set{2, 3, 5}} i^2 = (2)^2 + (3)^2 + (5)^2 = 38\]

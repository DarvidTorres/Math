...
Es claro que la \text{distancia} entre los límites de las sumatorias es un número entero, por lo que podemos proceder con la segunda definición de la sumatoria:

...
n}$. Decimos que $A$ es un conjunto finito si existe una
biyección $f: M \to A$, para algún $n \in \N$. \begin{itemize} \item Si $f$ y
$n$ existen, llamamos a $n$ la cardinalidad del conjunto. \item El conjunto
$\emptyset$ es considerado finito, de cardinalidad $0$. \end{itemize}

Usualmente la sumatoria se presenta con la notación índice para conjuntos finitos indexados, \[\sum_{i=m}^{n} a_i\]

en la cual se tiene una función $f:M \to A$ tal que $i \mapsto a$, donde $i\in \N$. La notación índice se define como:

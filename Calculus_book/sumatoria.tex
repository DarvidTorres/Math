...
Usualmente la sumatoria se presenta con la notación índice para funciones, \[\sum_{i=m}^{n} a_i\]

La cual implícitamente requiere una función biyectiva $f: N \to A$, donde $N\propersubset \N$, $A\propersubset \R$ y $a\in A$.

\textbf{Definición:} Sea $A\propersubset \R$ y $M=\set{m|1\leq m\leq
n}\propersubset \N$. Decimos que $A$ es un conjunto finito si existe una
biyección $f: A \to M$, para algún $n \in \N$. \begin{itemize} \item Si $f$ y

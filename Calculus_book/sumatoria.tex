...
Notemos que la variable iterable de la sumatoria A ($i$) estará determinando el valor del límite superior de la sumatoria B, por lo que únicamente requerimos un valor para $n$ que determine el límite superior de la sumatoria A para poder realizar el cálculo. Sea $n=1$.

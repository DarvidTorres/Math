...
\textbf{Definición:} Sea $A, B\subseteq \R$ y $f:A \to B$, con $a,b\in A$, y sea $n \in \set{a + m | m\in \Z, 0\leq m \leq (b-a)}$. Definimos al producto de $a$ hasta $b$ de $f$ como sigue:
...
\textbf{Observación:} $a^0 = \prod_{i=1}^{0} a = 1$, por definición; en particular (y bajo esta definición), $0^0=1$.

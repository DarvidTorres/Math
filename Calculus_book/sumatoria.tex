...
\textbf{Definición:} Sea $A, B\subseteq \R$ y $f:A \to B$, con $a,b\in A$. Definimos a la sumatoria de $a$ hasta $b$ de $f$ como sigue:
...
\textbf{Definición:} Llamamos al conjunto $\set{a + n | n\in \Z, 0\leq n \leq (b-a)}$, el conjunto iterable de $\sum_{n=a}^{b} f(n)$.


decimos que $n$ \textit{itera} desde $a$ hasta $b$.

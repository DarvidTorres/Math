...
\begin{align*}
  \sum_{i=0}^{n} \sum_{j=0}^{i} (i+1)(j+1) &= \sum_{i=0}^{1} \sum_{j=0}^{i=1} (i+1)(j+1)\\
  &= \sum_{i=0}^{1} \left(\sum_{j=0}^{i=1} (i+1)(j+1)\right)\\
  &= \left(\sum_{i=0}^{1} (i+1)\right) \cdot \left(\sum_{j=0}^{1} (j+1)\right)\\
  &= \left((0+1) + \sum_{i=1}^{1} (i+1)\right) \cdot \left(\sum_{j=0}^{i=0} (j+1) + \sum_{j=1}^{i=1}\right)\\
\end{align*}

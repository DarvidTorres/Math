...
\begin{enumerate}
  ...
  \item Sea $A=\set{2, 1/3, 3}$ y $A'= \set{a|a\in A\intersection \N}$ \[\sum_{a\in A'} a = 2 + 3 = 5\]
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \begin{align*}
    ...
    &= - \frac{13}{12} + \frac{13}{12} \cdot 0 + \sum_{k=1}^{1} \frac{13}{12}k\\
    &= - \frac{13}{12} + 0 + \frac{13}{12} \cdot 1\\
    &= 0
  \end{align*}
\end{enumerate}

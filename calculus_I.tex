...
$0<\frac{1}{n}\leq 1, \forall n\in \N$. \begin{proof}
  Sea $A \defined \set{n|0<\frac{1}{n} \leq 1, n\in \N}$. Notemos que $1\in A$, pues $0<\frac{1}{1} \leq 1$. Luego, si $n\in A$, tenemos que $0<\frac{1}{n} \leq 1$. También $n<n+1$, de donde sigue que $\frac{1}{n+1} < \frac{1}{n}$. Finalmente, como $n+1>0$, sigue que $\frac{1}{n+1}>0$, y por transitividad, $0<\frac{1}{n+1}\leq 1$. Como $\N$ es un conjunto inductivo, sigue que $n+1\in \N$, por lo que $n+1\in A$, y por el principio de inducción matemática, $A =\N$.
\end{proof}
...
Demostrar que $0<\frac{1}{n}\leq 1, \forall n\in \N$.
\begin{proof}

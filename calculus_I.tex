...
El lector notará que la prueba consiste en: \begin{enumerate}
  ...
  \item Demostrar que $A$ es un conjunto inductivo: \begin{itemize}
    ...
    \item Plantear que algún número natural $n$ pertenece a $A$. (Hipótesis de inducción).
...
\begin{enumerate}[label=\alph*)]
    ...
    \begin{enumerate}[label=\Roman*)]
      ...
      \begin{enumerate}[label=\roman*)]
        ...
        \begin{align*}
          ...
          &= \Bigl(f(a) + f(a+1)\Bigr) + \Bigl(g(a) + g(a+1)\Bigr)\\
  ...
  \textbf{Corolario:} \begin{enumerate}[label=\roman*)]
    \item Sea $s,t\in \R$, \[s\cdot \sum_{n=a}^{b} f(n) + t\cdot \sum_{n=a}^{b} g(n) = \sum_{n=a}^{b} \Bigl(s\cdot f(n) + t\cdot g(n)\Bigr)\]
    \begin{proof}
      \begin{align*}

...
\begin{enumerate}[label=\alph*)]
  ...
  \textbf{Nota:} $(b-a+1)$ es el número de \textit{iteraciones}, \textit{cíclos}, o \textit{sumandos} de la sumatoria $\sum_{n=a}^{b} f(n)$.
  ...
  \item Sea $c\in \R$, \[\sum_{n=a}^{b} \Bigl(c \cdot f(n)\Bigr) = c\cdot \sum_{n=a}^{b} f(n) \qquad \text{(Distributividad)}\]
    \begin{proof}\leavevmode
      \begin{enumerate}[label=\Roman*)]
        \item Si $a>b$, \begin{align*}
          \sum_{n=a}^{b} \Bigl(c \cdot f(n)\Bigr) = 0 = c\cdot 0 = c\cdot \sum_{n=a}^{b} f(n)
        \end{align*}
        \item Si $a=b$, \begin{align*}
          \sum_{n=a}^{b} \Bigl(c \cdot f(n)\Bigr) = c\cdot \sum_{n=a}^{b} f(n) 
        \end{align*}
        \item Si $b>a$,
          \begin{enumerate}[label=\roman*)]
          \item Se comprueba para $b=a+1$, \begin{align*}
  ...
  \item \[\sum_{n=a}^{b} f(n) \pm \sum_{n=a}^{b} g(n) = \sum_{n=a}^{b} \Bigl(f(n) \pm g(n)\Bigr) \qquad \text{Asociatividad}\]

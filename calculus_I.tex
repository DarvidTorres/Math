...
% \textbf{Nota:} Nos referiremos a (1) y (2) como ley de los signos. 
 ...
 \bfit{Observación:} $b-\frac{a+b}{2} = \frac{a+b}{2}-a$ (la \textit{distancia} de $a$ y $b$ al punto medio es la misma).
 ...
 \begin{enumerate}[label=\roman*)]
  ...
  Notemos que que $a<0 \Rightarrow 0<-a$, por lo que $-a^{-1}>0$, de donde sigue que $a^{-1}<0$.
  \item Si $0<a<1$, entonces $1<a^{-1}$.
  
  Notemos que $0<a \Rightarrow 0<a^{-1}$. Luego,
  \begin{align*}
    a &< 1\\
    a\cdot a^{-1} &< 1\cdot a^{-1}\\
    1 &< a^{-1}
   ...
   Notemos que $1 < a \Rightarrow 0 < a \Rightarrow 0 < a^{-1}$. Luego,
   \begin{align*}
    1 &< a\\
    1\cdot a^{-1} &< a\cdot a^{-1}\\
    0< a^{-1} &< 1
   ...
   Notemos que $a<0 \Rightarrow 0<-a$ y $-1 < a \Rightarrow -a < 1$, por lo que $0< -a < 1$. Luego,
   \begin{align*}
    1 &< -a^{-1}\\
    a^{-1} &< -1
   \end{align*}
   ...
   Notemos que $a<-1 \Rightarrow 1<-a$. Luego,
   \begin{align*}
    0<-a^{-1} &<1\\
    -1 < a^{-1} &< 0
   \end{align*}
   ...
   Notemos que $ab>0$. Como $a<1$, sigue que $ab<b$, y a su vez, $b<1$, por lo que $0<ab<1$.
   \item Si $-1<a<0$ y $0<b<1$, entonces $-1<ab<0$.
   
   Notemos que $ab<0$. Como $b<1$, sigue que $a<ab$, y a su vez $-1<a$, por lo que $-1<ab<0$.
   \item Si $-1<a<0$ y $-1<b<0$, entonces $0<ab<1$.
   
   $-1<a<0 \Rightarrow a^{-1}<-1 \Rightarrow 1<-a^{-1}$ y $-1<b<0 \Rightarrow b^{-1}<-1 \Rightarrow 1<-b^{-1} \Rightarrow 0<-b^{-1}$.
   \begin{align*}
    1 &< -a^{-1}\\
